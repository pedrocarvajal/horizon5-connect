    ...
    def __init__(self, allocation: float = 0.0) -> None:
        ...
        self._strategies = [
            ...
            EMA5BreakoutStrategy(
                ...
                enabled=False,
                settings={
                    "main_volume_percentage": 0.03,
                    "main_take_profit_percentage": 0.05,
                    "main_stop_loss_percentage": 0.25,
                    "recovery_maximum_number_of_openings": 3,
                    "recovery_take_profit_percentage": 0.05,
                    "recovery_stop_loss_percentage": 0.25,
                },
            ),
