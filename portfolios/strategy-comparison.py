"""Strategy comparison portfolio for prop firm evaluation."""
...
class TurtleAsset(AssetService):
...
class MebFaberAsset(AssetService):
    """XAUUSD asset with only Meb Faber Timing for testing."""
...
class Portfolio(PortfolioService):
    """Strategy comparison portfolio."""

    _id = "strategy-comparison"
