...
class TestCalculateTakeProfit(unittest.TestCase):
    ...
    def test_calculate_take_profit_percentage_buy_returns_higher_price(self) -> None:
    ...
    def test_calculate_take_profit_percentage_sell_returns_lower_price(self) -> None:
        result = calculate_take_profit(
            entry_price=self._ENTRY_PRICE,
            value=self._PERCENTAGE_VALUE,
            method=TpSlMethod.PERCENTAGE,
    ...
    def test_calculate_take_profit_atr_buy_returns_higher_price(self) -> None:
        result = calculate_take_profit(
            entry_price=self._ENTRY_PRICE,
    ...
    def test_calculate_take_profit_atr_sell_returns_lower_price(self) -> None:
        result = calculate_take_profit(
            entry_price=self._ENTRY_PRICE,
            value=self._ATR_MULTIPLIER,
            method=TpSlMethod.ATR,
    ...
    def test_calculate_take_profit_atr_without_atr_value_raises_error(self) -> None:
    ...
    def test_calculate_take_profit_fixed_buy_returns_higher_price(self) -> None:
        result = calculate_take_profit(
            entry_price=self._ENTRY_PRICE,
    ...
    def test_calculate_take_profit_fixed_sell_returns_lower_price(self) -> None:
        result = calculate_take_profit(
            entry_price=self._ENTRY_PRICE,
            value=self._FIXED_VALUE,
            method=TpSlMethod.FIXED,
    ...
    def test_calculate_take_profit_with_zero_value_returns_entry_price(self) -> None:
        test_cases = [
