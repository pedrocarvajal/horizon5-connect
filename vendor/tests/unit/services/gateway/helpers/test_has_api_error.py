...
from vendor.services.gateway.helpers.has_api_error import has_api_error
...
class TestHasApiError(unittest.TestCase):
    ...
    def test_has_api_error_with_error_code_and_message(self) -> None:
        response = {
            "code": self._ERROR_CODE_TIMESTAMP,
            "msg": self._ERROR_MSG_TIMESTAMP,
        }
    ...
    def test_has_api_error_with_zero_code(self) -> None:
        response = {
            "code": self._ERROR_CODE_ZERO,
            "msg": self._ERROR_MSG_SUCCESS,
        }
