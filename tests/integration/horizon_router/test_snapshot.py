...
class TestSnapshotResource(unittest.TestCase):
    ...
    def test_2_create_snapshot(self) -> None:
        snapshot_data = SnapshotCreateModel(strategy_id='673fa4234ba7a04b2b0e1be9', asset_id='673fa4234ba7a04b2b0e1be8', event=SnapshotEvent.START_SNAPSHOT, nav=10000.5, allocation=0.75, backtest=True)
