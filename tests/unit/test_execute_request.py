...
class TestExecuteRequest(unittest.TestCase):
    ...
    def _create_mock_response(
        self, status_code: int, json_data: Optional[Dict[str, Any]] = None, text: str = "OK"
    ) -> MagicMock:
    ...
    def test_execute_request_returns_none_on_http_error(self, mock_get: MagicMock) -> None:
        ...
        mock_get.return_value = mock_response
        result = execute_request(
            method="GET", url=self._TEST_URL, api_key=self._TEST_API_KEY, api_secret=self._TEST_API_SECRET
        )
