...
class TestGetSortinoRatio(unittest.TestCase):
    ...
    def test_get_sortino_ratio_with_risk_free_rate(self) -> None:
        result_with_rf = get_sortino_ratio(self._NAV_WITH_DOWNSIDE, risk_free_rate=self._RISK_FREE_RATE_WITH)
        result_without_rf = get_sortino_ratio(self._NAV_WITH_DOWNSIDE, risk_free_rate=self._RISK_FREE_RATE_WITHOUT)
